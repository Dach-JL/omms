...
| Transaction Ref | _(empty)_           | ❌ Error: Required field       |
| Receipt Upload  | _Upload test image_ | ✅ Valid (JPG/PNG < 2MB)       |
| Receipt Upload  | _PDF file_          | ❌ Error: Images only          |
...
_Purpose: Comprehensive testing guide for Telebirr payment integration_
